...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-12-29 00:56`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/729c18ec-9e31-4dac-acfc-aaed5385121c.git
$ cd 729c18ec-9e31-4dac-acfc-aaed5385121c
```
